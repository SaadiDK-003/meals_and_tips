...
if (isset($_POST['recipe_title']) && isset($_POST['ingredients'])):
    ...
    $recipe_Q = $db->query("INSERT INTO `recipes` (recipe_title,ingredients,instructions,nutritionist_id,cat_id) VALUES('$recipe_title','$ingredients','$instructions','$nutritionist_id','$category_id')");
    if ($recipe_Q):
